...
//
//   States (saveState property): "idle" | "uploading" | "done" | "linked"
//
//   Signals:
...
Rectangle {
    ...
    onSaveStateChanged: {
        ...
        else if (saveState === "idle") { progress = 0 }
            ...
            ColumnLayout {
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        HoverHandler { id: sh; enabled: parent.isIdle }
                        TapHandler {
                            enabled: parent.isIdle
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Text { text: "Generar enlace compartido"
                                   color: W.Tokens.bgBase
                                   font.family: W.Tokens.sans
                                   font.pixelSize: 13.5; font.weight: Font.Bold; font.letterSpacing: 0.4 }
                        }
                    }
