...
//     notification   : var     ClipRequest.to_dict() — flat fields:
//                              { id, created_at, supervisor_host, operator,
...
//     declined()             user pressed "Declinar"
//     toggleExpanded()
//     simulateIncoming()     (unused in production — kept for dev tools)
    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Text {
                    text: notification
                          ? "· " + (notification.created_at || "").replace("T", " ").substring(0, 19)
                          : ""
            ...
            RowLayout {
                ...
                RowLayout {
                    ...
                    W.OperatorAvatar {
                        ...
                        initials: notification
                                  ? (notification.supervisor_host || "??").substring(0, 2).toUpperCase()
                                  : "··"
                    }
                    ColumnLayout {
                        spacing: 2
                        Text {
                            text: notification ? (notification.supervisor_host || "") : ""
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Text {
                                ...
                                text: notification
                              ? (notification.storage || "") + "/raw/" + (notification.operator || "")
                              : ""
                                color: W.Tokens.textPrimary
                                font.family: W.Tokens.mono
                                font.pixelSize: 13
                ...
                ColumnLayout {
                    spacing: 4
                    Text {
                        text: "VENTANA · " + (notification ? (notification.operator || "") : "")
                    ...
                    RowLayout {
                        spacing: 8
                        Text {
                            text: notification ? (notification.start_time || "").replace(" ", " · ") : ""
                            color: W.Tokens.textPrimary
                            font.family: W.Tokens.mono
                            font.pixelSize: 13
                        }
                        Text { text: "→"; color: W.Tokens.textMuted
                               font.pixelSize: 14; font.weight: Font.Bold }
                        Text {
                            text: notification ? (notification.end_time || "").replace(" ", " · ") : ""
                            color: W.Tokens.textPrimary
                            font.family: W.Tokens.mono
                            font.pixelSize: 13
                        }
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    Text {
                        ...
                        text: notification ? (notification.operator || "") : ""
                        color: W.Tokens.accentYellow
                        font.family: W.Tokens.mono; font.pixelSize: 11
                        font.weight: Font.Bold; font.letterSpacing: 0.8
                    }
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        spacing: 14
                        Text {
                            text: notification ? "INICIO " + (notification.start_time || "") : ""
                            color: W.Tokens.textMuted
                            font.family: W.Tokens.mono; font.pixelSize: 12
                        }
                        Text { text: "→"; color: W.Tokens.textDim }
                        Text {
                            text: notification ? "FIN " + (notification.end_time || "") : ""
                            color: W.Tokens.textMuted
                            font.family: W.Tokens.mono; font.pixelSize: 12
                        }
                    }
