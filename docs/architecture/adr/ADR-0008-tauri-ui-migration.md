...
[`app/adapters/ui/`](../../../project/app/adapters/ui). El bundle PyInstaller pesa ~259 MB (Qt domina).
...
`adapters/ws/*` (solo el argumento `parent`) y en [`app/main.py`](../../../project/app/main.py) (bootstrap
...
- **QML + PySide6 se eliminan por completo** en el cutover (F3): 0 `.qml`, 0 imports de PySide6, sin
  ...
  híbrido permanente.
- **Reutilizar** los scripts existentes [`run.ps1`](../../../project/run.ps1) (pruebas visuales) y
  [`installer/build.ps1`](../../../project/installer/build.ps1) (empaquetado), evolucionados — no scripts
  paralelos.
