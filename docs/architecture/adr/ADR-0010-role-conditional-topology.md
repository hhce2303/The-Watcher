...
- El **single-instance**, **tray** y **autostart** del Operador los gobierna el daemon/watchdog, no la
  ...
  [`app/core/role.py`](../../../project/app/core/role.py) y [`app/main.py`](../../../project/app/main.py).
...
- Depende del scheduled-task watchdog ([`app/infrastructure/scheduled_task.py`](../../../project/app/infrastructure/scheduled_task.py)).
