...
- **Mecanismo:** **PyO3 in-process**, port por port detrás de los `core/ports/*` existentes (mismo
  patrón que [`adapters/native/rust_segment_compiler.py`](../../../project/app/adapters/native/rust_segment_compiler.py)).
...
- ➖ **Riesgo F7 (confianza 9/10):** el scaffold [`native/watcher_segments`](../../../project/native/watcher_segments)
