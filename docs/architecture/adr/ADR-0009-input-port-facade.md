...
[`app/core/ports/`](../../../project/app/core/ports) (`RecorderPort`, `ClipPort`, `CloudSharePort`,
...
- [`app/adapters/ui/app_bridge.py:367`](../../../project/app/adapters/ui/app_bridge.py#L367) → `self._recording_service.start()`
- [`app/adapters/ui/app_bridge.py:355`](../../../project/app/adapters/ui/app_bridge.py#L355) → `self._event_service.trigger_manual_event()`
- [`app/adapters/ui/editor_bridge.py:87`](../../../project/app/adapters/ui/editor_bridge.py#L87) → `self._timeline.add(ClipEntry(...))`
