...
> [ADRs](../architecture/adr/README.md) y el [gate F0](howto-f0-gate.md).
...
- ✅ **Named pipe de Windows** (scoped al usuario) o **token burned-in en build-time** sobre loopback;
  nunca puerto TCP abierto. Ver [ADR-0011](../architecture/adr/ADR-0011-local-ipc-security.md).
...
- ✅ CI con `tauri-action` (matriz de OS) para MSI/NSIS; reusa/evoluciona
  [`build.ps1`](../../project/installer/build.ps1) en lugar de scripts paralelos.
...
## Relacionado
- [Explicación](explanation-tauri-migration.md) · [Referencia](reference-target-architecture.md) · [Gate F0](howto-f0-gate.md) · [ADRs](../architecture/adr/README.md)
