...
> `adapters/ipc`. Ver [ADR-0009](../architecture/adr/ADR-0009-input-port-facade.md). Si la vista usa una
...
## Relacionado
- [Referencia — Contrato IPC](reference-target-architecture.md) · [ADR-0009](../architecture/adr/ADR-0009-input-port-facade.md)
