...
> [ADR-0006](../architecture/adr/ADR-0006-rust-segment-engine.md) (`SegmentCompilerPort` + `.pyd` PyO3 +
> fallback FFmpeg). Ver [ADR-0012](../architecture/adr/ADR-0012-rust-hexagon-endgame.md).
...
## Relacionado
- [ADR-0012](../architecture/adr/ADR-0012-rust-hexagon-endgame.md) · [ADR-0006](../architecture/adr/ADR-0006-rust-segment-engine.md) · [Referencia — Matriz de puertos](reference-target-architecture.md)
