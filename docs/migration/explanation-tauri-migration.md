...
`adapters/`) quedan intactos. Ver [ADR-0008](../architecture/adr/ADR-0008-tauri-ui-migration.md).
...
3. **Rust como destino, no como shell.** El core es el destino de Rust. Los `core/ports/*` son la
   ...
   (grabación/segmentos). Ver [ADR-0012](../architecture/adr/ADR-0012-rust-hexagon-endgame.md).
...
- [ADR-0008](../architecture/adr/ADR-0008-tauri-ui-migration.md) · [ADR-0012](../architecture/adr/ADR-0012-rust-hexagon-endgame.md) · [ADR-0006 (motor de segmentos Rust)](../architecture/adr/ADR-0006-rust-segment-engine.md)
